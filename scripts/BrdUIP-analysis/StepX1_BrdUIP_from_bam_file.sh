...
#From bam file generated by Step2_Mapping.sh [you may use "[out_bam_file_name].[genome_name].clean_srt_markdup.bam"]
#This script will generate bedgraph file of BrdUIP & ${out_dir}/fragment for saving the Rdata 
#ver. 210304
...
if [ $# -le 4 ] ; then
    ...
    echo "arguments:"
    echo ""
    echo "Early_S			Input fragment bam file (Early-S fraction generated by Step2_Mapping.sh)"
    echo "Late_S			Input fragment bam file (Late-S fraction generated by Step2_Mapping.sh)"
    ...
    echo "[name]_mapq10_blacklist_fragment.Rdata under fragment directory" 
    echo ""
    exit 0
fi

echo "#Repli-seq StepX_IP analysis of BrdUIP from bam file data start: `date`"

rscript="/usr/local/bin/util/repliseq_from_bam.r"
EarlyS=$1
LateS=$2
name=$3 
out_dir=$4
...
echo "#Repli-seq StepX_IP analysis of BrdUIP data from bam file end: `date`"
